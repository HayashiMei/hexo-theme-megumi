$(document).ready(function () {
  ...
  const sidebarToggleMotion = {
    ...
    touchendHandler: function (e) {
      const _xPos = e.originalEvent.changedTouches[0].clientX;
      const _yPos = e.originalEvent.changedTouches[0].clientY;
  ...
  NexT.motion.middleWares = {
    logo: function (integrator) {
      ...
      const $logoLineTop = $('.logo-line-before i');
      const $logoLineBottom = $('.logo-line-after i');
    ...
    postList: function (integrator) {
      const $post = $('.post:not(.post-block)');
      const $postBlock = $('.post-block, .pagination, .comments');
      ...
      const $collHeader = $('.collection-title, .archive-year');
      const $collHeaderTransition = CONFIG.motion.transition.coll_header;
      const $sidebarAffix = $('.sidebar-inner');
      ...
      function postMotion() {
        ...
        postMotionOptions.complete = function () {
          ...
          if (
            CONFIG.motion.transition.sidebar &&
            (NexT.utils.isPisces() || NexT.utils.isGemini())
          ) {
        ...
        if (
          ...
          $sidebarAffix.velocity(
            'transition.' + $sidebarAffixTransition,
            postMotionOptions
          );
        }
      }
